...
######################
#
# To run, execute python contextSerial.py at the prompt.
#
...
# working directory.
#
# WARNING: This code was developed on a Python 2.7 build and may
# not run as expected on other configurations.
#
######################
